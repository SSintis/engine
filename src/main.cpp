...
int main()
{
    ...
    SpriteObject newSprite("/home/emo_profisional/programingCplusPlus/engine/assets/as.jpg", 0, 150, 0.1);
    ...
    while (engine.gameIsOn()){
        ...
        text.setString("fesfefse: " + playerScoreString.str());//задает строку тексту
